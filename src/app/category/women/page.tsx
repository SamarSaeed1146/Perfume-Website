// app/category/women/page.tsx (or pages/category/women.tsx)
"use client";
...
export default function WomensFragrancesPage() {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      ...
      const data = getProductsByCategory("women"); // Filter for 'women' category
    ...
    <div className="bg-gray-950 text-white min-h-screen font-sans">
      ...
      <section className="relative py-20 md:py-28 lg:py-36 flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="relative z-10 px-4 max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 max-w-2xl mx-auto">
            Explore elegant and captivating perfumes that celebrate the essence
            of femininity.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto">
        {loading ? (
          ...
          <div className="text-center text-xl text-gray-400">
            No women&#39;s fragrances found at the moment.
          </div>
        ) : (
